...
class PhoneRechargesDataSource{
  ...
  Future recharge(String phone, String latitud, String longitud, String firma) async{
    ...
    if (response.statusCode == 200){
      ...
      return rechargeResponseFromJson('{"operacionExitosa": false,"redirigir": false,"mensaje": "Intente de nuevo mas tarde ${response.statusCode}","urlRedireccion": "","codigoError": 0}');
    }
  }
  ...
  Future record(String startDate, String endDate, String firma) async{
    ...
    if (response.statusCode == 200){
      ...
      return recordResponseFromJson('{"operacionExitosa": false,"redirigir": false,"mensaje": "Intente de nuevo mas tarde ${response.statusCode}","urlRedireccion": "","codigoError": 0}');
    }
  }
  ...
  Future childrens(String firma) async{
    ...
    final response = await _client.get(Uri.parse(
        "$BASE_URL?idOperacion=obtenerHijos&firma=$firma"
    ));
    ...
    if (response.statusCode == 200){
      ...
      return childrensResponseFromJson('{"operacionExitosa": false,"redirigir": false,"mensaje": "Intente de nuevo mas tarde ${response.statusCode}","urlRedireccion": "","codigoError": 0}');
    }
  }
  ...
  Future transfers(String idHijo, String lineaTransferir, String firma) async{
    ...
    if (response.statusCode == 200){
      ...
      return genericResponseFromJson('{"operacionExitosa": false,"redirigir": false,"mensaje": "Intente de nuevo mas tarde ${response.statusCode}","urlRedireccion": "","codigoError": 0}');
    }
  }
