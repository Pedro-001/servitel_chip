...
class NewsDataSource implements NewsRepository{
  ...
  Future getNews(String firma) async{
    final response = await _client.get(Uri.parse(
        "$BASE_URL?idOperacion=obtenerNoticias&firma=$firma"
    ));
    ...
    if (response.statusCode == 200){
      ...
      return newsResponseFromJson('{"operacionExitosa": false,"redirigir": false,"mensaje": "Intente de nuevo mas tarde ${response.statusCode}","urlRedireccion": "","codigoError": 0}');
    }
  }
